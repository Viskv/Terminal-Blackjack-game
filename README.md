...
language: C
compiller: gcc -std=c99 -pedantic -wall -werror
----------------------------------------------
File structure:
...
3. B.J. Check:	Player wins immediately if initial score is 21 (1.5x payout).
4. Player turn:	Player chooses to 'Hit' or 'Stand'. Player busts if the score exceeds 21.
5. Dealer turn:	Dealer reveals their hidden card and hits until their score is 17 or more.
6. Outcome: 	Final scores are compared to determine the winner (2x payout) or a push/tie (pot carries over).
6. Reset Cards:	All cards are returned to the deck, and the user is prompted to play again.
----------------------------------------------
[unit8_t card]
